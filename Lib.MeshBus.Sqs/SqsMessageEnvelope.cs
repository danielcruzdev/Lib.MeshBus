...
/// <summary>
/// JSON envelope stored as the SQS message body.
...
internal sealed class SqsMessageEnvelope
{
    ...
    {
        var envelope = JsonSerializer.Deserialize<SqsMessageEnvelope>(rawBody)
            ?? throw new InvalidOperationException("Failed to deserialize SQS message envelope.");
