...
/// <summary>
/// JSON envelope used as the Cloud Tasks HTTP body.
/// Wraps all MeshBus metadata and the serialized payload.
/// </summary>
internal sealed class CloudTasksMessageEnvelope
{
    ...
    {
        var envelope = JsonSerializer.Deserialize<CloudTasksMessageEnvelope>(rawBody)
            ?? throw new InvalidOperationException("Failed to deserialize Cloud Tasks message envelope.");
